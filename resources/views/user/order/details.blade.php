                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <address>
                                                ...
                                                Name: {{$data->shop_name}}<br>
                                                Phone: {{$data->shop_number}}<br>
                                                Address: {{$data->shop_address}}<br>
                                            </address>
                                        </div>
                                        <div class="col-md-6">
                                            <h5><b>Logistics Company</b></h5>
                                            <address>
                                        ...
                                        <table class="table table-bordered veiw-details-table">
                                            ...
                                            <tbody>
                                                @foreach($cart->items as $product)
                                                    @if($product['item']['user_id'] == $data->vendor_id)
                                                        <tr>
                                    ...
                                    <div class="row my-4 d-flex justify-content-between">
                                        ...
                                        <h3 class="order-code">
                                            @if($data->delivery_status == 1)
                                                {{ $langg->lang285 }} {{$order->order_number}} [Delivery Accepted]
                                            @elseif($data->delivery_status == 2)    
                                                {{ $langg->lang285 }} {{$order->order_number}} [On Delivery]
                                            @elseif($data->delivery_status == 3)    
                                                {{ $langg->lang285 }} {{$order->order_number}} [Delivered] 
                                            @endif   
                                        </h3>
                                        @if($data->delivery_status == 2)
                                            <div class="print-order text-left">
                                                <form action="{{ route('user-order-confirm') }}" method="POST" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                    <input type="text" value="{{$order->order_number}}" style="display:none;" name="order_number">

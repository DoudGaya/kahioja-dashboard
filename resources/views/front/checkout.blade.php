											...
											<div class="order-area">
												...
												<div class="order-item">
													...
													<div class="product-content">
														...
														<div class="total-price">
															<p>@if($product['item']['ship_fee'] != 0)
																<h5 class="label">Delivery Fee: {{ App\Models\Product::convertPrice($product['item']['ship_fee']) }} </h5>
																@else
																<h5 class="label">Delivery Fee: Free Delivery </h5>
																@endif
															</p>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="nav flex-column"  role="tablist" aria-orientation="vertical">
															...
															@endif
															@if($gs->is_flutterwave == 1)
																<a class="nav-link payment" data-val="flutterwave" data-show="no" data-form="{{route('flutterwave.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'flutterwave','slug2' => 0]) }}" id="v-pills-tab7-tab" data-toggle="pill" href="#v-pills-tab7" role="tab" aria-controls="v-pills-tab7" aria-selected="false">
																		<div class="icon">
																				<span class="radio"></span>
																		</div>
																		<p>
							...
							<h4 class="title">{{ $langg->lang127 }}</h4>
								<ul class="order-list">
									...
									<li>
										...
										<P>
										<b class="cart-shipping-fee">{{ Session::has('cart') ? App\Models\Product::convertPrice($shipping_fee) : '0.00' }}</b>
										</P>
									</li>
									<li>
										<p>
										...
										<P>
											...
											<b class="cart-total">{{ App\Models\Product::convertPrice($total_price_products) }}</b>
										</P>
									</li>
									@if($gs->tax != 0)
									<li>
